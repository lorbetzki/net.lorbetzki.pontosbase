			...
			if ($this->ReadPropertyInteger('UpdateDataInterval') == 0){
				...
				$this->SetStatus(102);
						...
						if (!@IPS_VariableProfileExists("PontosBase.SLP"))
						{
							...
							IPS_SetVariableProfileAssociation("PontosBase.SLP", 1, "2 ".$this->Translate('days'), "", 0x00FF00);
							IPS_SetVariableProfileAssociation("PontosBase.SLP", 2, "3 ".$this->Translate('days'), "", 0x00FF00);
							IPS_SetVariableProfileAssociation("PontosBase.SLP", 3, "4 ".$this->Translate('days'), "", 0x00FF00);
							IPS_SetVariableProfileAssociation("PontosBase.SLP", 4, "5 ".$this->Translate('days'), "", 0x00FF00);
							IPS_SetVariableProfileAssociation("PontosBase.SLP", 5, "6 ".$this->Translate('days'), "", 0x00FF00);
							IPS_SetVariableProfileAssociation("PontosBase.SLP", 6, "7 ".$this->Translate('days'), "", 0x00FF00);
							IPS_SetVariableProfileAssociation("PontosBase.SLP", 7, "8 ".$this->Translate('days'), "", 0x00FF00);
							IPS_SetVariableProfileAssociation("PontosBase.SLP", 8, "9 ".$this->Translate('days'), "", 0x00FF00);
							IPS_SetVariableProfileAssociation("PontosBase.SLP", 9, "10 ".$this->Translate('days'), "", 0x00FF00);
							IPS_SetVariableProfileAssociation("PontosBase.SLP", 10, "11 ".$this->Translate('days'), "", 0x00FF00);
							IPS_SetVariableProfileAssociation("PontosBase.SLP", 11, "12 ".$this->Translate('days'), "", 0x00FF00);
							IPS_SetVariableProfileAssociation("PontosBase.SLP", 12, "13 ".$this->Translate('days'), "", 0x00FF00);
							IPS_SetVariableProfileAssociation("PontosBase.SLP", 13, "14 ".$this->Translate('days'), "", 0x00FF00);
							IPS_SetVariableProfileAssociation("PontosBase.SLP", 14, "15 ".$this->Translate('days'), "", 0x00FF00);
							IPS_SetVariableProfileAssociation("PontosBase.SLP", 15, "16 ".$this->Translate('days'), "", 0x00FF00);
							IPS_SetVariableProfileAssociation("PontosBase.SLP", 16, "17 ".$this->Translate('days'), "", 0x00FF00);
							IPS_SetVariableProfileAssociation("PontosBase.SLP", 17, "18 ".$this->Translate('days'), "", 0x00FF00);
							IPS_SetVariableProfileAssociation("PontosBase.SLP", 18, "19 ".$this->Translate('days'), "", 0x00FF00);
							IPS_SetVariableProfileAssociation("PontosBase.SLP", 19, "20 ".$this->Translate('days'), "", 0x00FF00);
							IPS_SetVariableProfileAssociation("PontosBase.SLP", 20, "21 ".$this->Translate('days'), "", 0x00FF00);
							IPS_SetVariableProfileAssociation("PontosBase.SLP", 21, "22 ".$this->Translate('days'), "", 0x00FF00);
							IPS_SetVariableProfileAssociation("PontosBase.SLP", 22, "23 ".$this->Translate('days'), "", 0x00FF00);
							IPS_SetVariableProfileAssociation("PontosBase.SLP", 23, "24 ".$this->Translate('days'), "", 0x00FF00);
							IPS_SetVariableProfileAssociation("PontosBase.SLP", 24, "25 ".$this->Translate('days'), "", 0x00FF00);
							IPS_SetVariableProfileAssociation("PontosBase.SLP", 25, "26 ".$this->Translate('days'), "", 0x00FF00);
							IPS_SetVariableProfileAssociation("PontosBase.SLP", 26, "27 ".$this->Translate('days'), "", 0x00FF00);
							IPS_SetVariableProfileAssociation("PontosBase.SLP", 27, "28 ".$this->Translate('days'), "", 0x00FF00);
